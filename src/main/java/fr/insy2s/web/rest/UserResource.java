...
public class UserResource {
   ...
   /**
    * verifie si un login existe en BDD
    * @param login le login à vérifier
    * @return true with status {@code 200 (OK)}si il existe, false with status {@code 400 (BAD_REQUEST)} 
    */
    @GetMapping("users/loginexiste/{login}")
    public ResponseEntity<?> getAllUsers(@PathVariable String login) {
    	if (userService.findOneByLogin(login)) {
