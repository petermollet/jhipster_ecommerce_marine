...
export const ArticleDeleteDialog = (props: IArticleDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eCommerceJhipsterV1App.article.delete.question">
        <Translate contentKey="eCommerceJhipsterV1App.article.delete.question" interpolate={{ id: articleEntity.id }}>
